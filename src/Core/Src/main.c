...
int main(void)
{
  ...
  while (1) {
    ...
    if (HAL_GetTick() - LORA_GetLastSendTick() >= 10000) {
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, SX_RST_Pin|NEO_RST_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(SPI2_CS0_GPIO_Port, SPI2_CS0_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, USER_LED_Pin|SPI1_CS0_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : SX_INT_Pin SX_BUSY_Pin */
  GPIO_InitStruct.Pin = SX_INT_Pin|SX_BUSY_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : SX_RST_Pin NEO_RST_Pin */
  GPIO_InitStruct.Pin = SX_RST_Pin|NEO_RST_Pin;
