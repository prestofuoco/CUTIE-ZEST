...
/* Private defines -----------------------------------------------------------*/
#define SX_INT_Pin GPIO_PIN_13
#define SX_INT_GPIO_Port GPIOC
#define SX_RST_Pin GPIO_PIN_14
#define SX_RST_GPIO_Port GPIOC
#define NEO_RST_Pin GPIO_PIN_15
#define NEO_RST_GPIO_Port GPIOC
...
#define SX_BUSY_GPIO_Port GPIOC
